...
// Entry rule entryRuleOtherRoot
entryRuleOtherRoot returns [EObject current=null]:
	{ newCompositeNode(grammarAccess.getOtherRootRule()); }
	iv_ruleOtherRoot=ruleOtherRoot
	{ $current=$iv_ruleOtherRoot.current; }
	EOF;

// Rule OtherRoot
ruleOtherRoot returns [EObject current=null]
@init {
	enterRule();
}
@after {
